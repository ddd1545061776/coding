jQuery(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#code-div').after("<div class=\"row\">\n" +
                    ...
                    "<div class=\"row col-10\">\n" +
                    "                                            <div class=\"card card-body col-6\">\n" +
                    "                                                <h4 class=\"card-title font-16 mt-0 font-weight-bolder\">运行结果: "+errorMessage+"</h4>\n" +
                    "                                                <div class=\"card-text\" id='card-error'>"+""+"" +
                    "                                                </div>\n" +
                    // "                                                <p class=\"card-text\">\n 消耗内存：0kb" +
                    //                     // "                                                </p>\n" +
    ...
    $('#language-dropdown').on('click', 'a', function() {
        ...
        if (mode =="java"||mode =="python"){
            $('#code-submit').removeAttr("hidden");
        }else{
            $('#code-submit').attr("hidden","hidden");
        }
        switch (mode) {
