...
public class QuestionController {
    ...
    @ResponseBody
    public String codeTest(@RequestBody Map<String, String> map) {
        ...
        JudgeResult result = judgeService.runCode(source, compilerId);
    ...
    public String codeJudge(@RequestBody Map<String, String> map) {
        ...
        String[] split = inputExamples.get(0).getInputType().split("#");
        // 调用判题服务进行判断
        JudgeResult judgeResult = judgeService.judge(judgeTask,split);
