...
public class ClassServiceImpl extends BaseServiceImpl<Class, ClassMapper> implements ClassService {
    ...
    @Override
    public List<ClassInformation> getClassSubmitNum(Long order) {
        return classMapper.getClassSubmitNum(order);
    }

    @Override
    public List<ClassInformation> getClassSuccessNum(Long order) {
        return classMapper.getClassSuccessNum(order);
    }

    @Override
    public List<ClassInformation> getNumWithWeekByQuestionId(Long questionId) {
        return classMapper.getNumWithWeekByQuestionId(questionId);
    }

    @Override
    public int getSuccessNumWithWeekByQuestionId(Long questionId) {
        return classMapper.getSuccessNumWithWeekByQuestionId(questionId);
    }

    @Override
    public int getAllNumWithWeekByQuestionId(Long questionId) {
        return classMapper.getAllNumWithWeekByQuestionId(questionId);
    }
}
